...
class ProductModel {
  ...
  factory ProductModel.fromSnapshot(
    ...
    // print('data');
    //print(data); //compila
    // String path = (data['ProductAttributes'][0] as DocumentReference<Map<String, dynamic>>).path;
    // print(path);
    ...
    //     print(ProductAttributeModel.fromSnapshot(documentSnapshot as DocumentSnapshot<Map<String, dynamic>>));
    //   }
    // });
